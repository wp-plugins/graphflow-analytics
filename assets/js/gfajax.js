...
jQuery( document ).ready(function( $ ) {
	...
	$( ".graphflow_recommendations_placeholder" ).each(function(i){
        ...
        if (typeof woocommerce_params.wc_ajax_url !== undefined && woocommerce_params.wc_ajax_url != null) {
            endpoint = woocommerce_params.wc_ajax_url.toString().replace( '%%endpoint%%', 'graphflow_get_recs' );
        } else {
            endpoint = woocommerce_params.ajax_url;
        }
		$.ajax({
	        url: endpoint,
	        type: 'POST',
